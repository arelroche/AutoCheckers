...
class CAction(object):
    ...
    def undo(self):
        ...
        RETURN:
            @return: Undo Action
        '''
        raw_undo = CAction('UNDO', self.destination, self.source, self.captured, self.promote)
    ...
    def copy(self):
        return CAction(self.type, self.source, self.destination, self.captured, self.promote)
